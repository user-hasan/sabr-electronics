...
const config: ExpoConfig = {
  ...
  android: { package: "com.sabr.electronics", adaptiveIcon: { backgroundColor: "#0E2238", foregroundImage: "./assets/images/android-icon-foreground.png", backgroundImage: "./assets/images/android-icon-background.png", monochromeImage: "./assets/images/android-icon-monochrome.png" }, edgeToEdgeEnabled: true, predictiveBackGestureEnabled: false, permissions: ["CAMERA", "READ_MEDIA_IMAGES", "POST_NOTIFICATIONS"] },
  web: { bundler: "metro", output: "static", favicon: "./assets/images/favicon.png" },
  plugins: ["expo-router", ["expo-build-properties", { android: { minSdkVersion: 28 } }], ["expo-image-picker", { photosPermission: "اسمح لـ Saber Electronics بالوصول إلى الصور لإرفاقها بسجل الجهاز." }], ["expo-local-authentication", { faceIDPermission: "اسمح لـ Saber Electronics باستخدام Face ID لفتح التطبيق." }], "expo-notifications", "expo-document-picker", ["expo-splash-screen", { image: "./assets/images/splash-icon.png", imageWidth: 200, resizeMode: "contain", backgroundColor: "#FFFFFF" }]],
